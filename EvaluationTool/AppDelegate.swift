...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func searchData() -> NSArray {
       let request = NSFetchRequest(entityName: "PersonalLog")
       var result = [AnyObject]?()
        do{  result = try self.cdh.managedObjectContext.executeFetchRequest(request)
        }
        catch {
           print("search error")
           result = nil
...
//        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.pingan.EvaluationTool" in the application's documents Application Support directory.
...
//        let modelURL = NSBundle.mainBundle().URLForResource("EvaluationTool", withExtension: "momd")!
